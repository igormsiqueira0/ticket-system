...
set BARRIER_SIZE=3
@echo Tamanho do grupo na barreira = %BARRIER_SIZE%
java -cp %CP_ZK% -Dlogback.configurationFile=file:%ZK%\conf\logback.xml SyncPrimitive worker localhost %BARRIER_SIZE%